...
<header>
    ...
    <section class="portfolio">
        <div class="container">
            <h1 class="text-center">Boda Civil</h1>
            <p class="text-center">Capturamos la elegancia y sencillez de tu boda civil, resaltando cada detalle especial. Momentos íntimos, llenos de amor y emociones, que quedarán inmortalizados en fotografías únicas.</p>
            <div class="gallery">
                <div class="gallery-item tall">
                    <img src="{{ asset('imagenes/portafolios/BODA-88.jpg') }}" alt="Trabajo 1">
                </div>
                <div class="gallery-item wide">
                    <img src="{{ asset('imagenes/portafolios/BODA-25.jpg') }}" alt="Trabajo 2">
                </div>
                <div class="gallery-item">
                    <img src="{{ asset('imagenes/portafolios/pc2.jpg') }}" alt="Trabajo 3">
                </div>
                <div class="gallery-item tall">
                    <img src="{{ asset('imagenes/portafolios/BODA-57.jpg') }}" alt="Trabajo 4">
                </div>
                <div class="gallery-item">
                    <img src="{{ asset('imagenes/portafolios/BODA-85.jpg') }}" alt="Trabajo 5">
                </div>
                <div class="gallery-item wide">
                    <img src="{{ asset('imagenes/portafolios/BODA-86.jpg') }}" alt="Trabajo 6">
                </div>
            </div>
        </div>
    </section>

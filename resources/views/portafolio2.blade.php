...
<header>
    ...
    <section class="portfolio">
        <div class="container">
            <h1 class="text-center">Sesión de Parejas</h1>
            <p class="text-center">Momentos llenos de amor y complicidad capturados en escenarios únicos. Cada fotografía refleja la esencia de la pareja, destacando su conexión y emociones en un ambiente natural y romántico.</p>
            <div class="gallery">
                <div class="gallery-item tall">
                    <img src="{{ asset('imagenes/portafolios/pi4.jpg') }}" alt="Trabajo 1">
                </div>
                <div class="gallery-item wide">
                    <img src="{{ asset('imagenes/portafolios/PRE SESION-16.jpg') }}" alt="Trabajo 2">
                </div>
                <div class="gallery-item">
                    <img src="{{ asset('imagenes/portafolios/PRE SESION-20.jpg') }}" alt="Trabajo 3">
                </div>
                <div class="gallery-item tall">
                    <img src="{{ asset('imagenes/portafolios/PRE SESION-25.jpg') }}" alt="Trabajo 4">
                </div>
                <div class="gallery-item">
                    <img src="{{ asset('imagenes/portafolios/PRE SESION-39.jpg') }}" alt="Trabajo 5">
                </div>
                <div class="gallery-item wide">
                    <img src="{{ asset('imagenes/portafolios/PRE SESION-43.jpg') }}" alt="Trabajo 6">
                </div>
            </div>
        </div>
    </section>
